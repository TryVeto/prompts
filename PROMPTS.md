...
Ask only the unresolved question that would materially change the assignment. When the brief is already clear, preserve it and skip this ceremony.

RETURN
The proposed brief and recommendation, the decisive trade-off, the evidence or example that changed your view, and the feasible next making step. Keep deeper support in linked notes. Do not mark the brief approved until I accept it.
