...
DEPTH AND AMBITION
Aim to spend a full 60 minutes of active, substantive work on this assignment in this turn. Assume there is more than an hour of valuable work available: prioritize the work that will most improve the next deliverable. A complete first draft is a checkpoint, not the finish line. If you reach it early, use the remaining time to deepen the research, challenge assumptions, compare stronger alternatives, resolve gaps across individual surfaces, improve the artifact, and verify the result.

Work through repeated inspect → improve → verify passes within the agreed scope. Save useful checkpoints as you go and reserve the final part of the hour for verification and delivery. Develop clear written evidence, assumptions, trade-offs, and rationale so I can review the decisions. Do not fill time with idle waits, repetitive checks, unnecessary pages, or scope expansion.

Do not stop early merely because the minimum requirements are met. If a genuine environment, context, tool, or permission limit prevents further progress, save the strongest usable result and state the specific limit and remaining work. Report elapsed work only when measured; do not imply that this instruction guarantees a runtime or that work continues after your response.
...
DEPTH AND AMBITION
Aim to spend a full 60 minutes of active, substantive research and synthesis on this assignment in this turn. Assume there is more than an hour of valuable work available. The first plausible recommendation is a checkpoint, not the finish line. Do not stop merely because you can name a convincing reference or write a polished summary.

Use the remaining effort to challenge the recommendation: investigate strong alternatives from this domain and adjacent domains, inspect specific workflows and individual surfaces, and seek evidence that could overturn the leading choice. Compare references against our actual users, jobs, constraints, and accepted taste. Distinguish observed product behavior from documentation, marketing claims, and inference. If the primary reference still wins, deepen the explanation of why, identify where it fails to transfer, and turn its useful principles into concrete guidance for our work.

When broader search stops changing the decision, shift effort into deeper inspection and a stronger synthesis. Resolve conflicts between combined references, map the most useful patterns to our important surfaces and connected journeys, and sharpen the making brief and next experiment. Save useful checkpoints and reserve the final part of the hour for checking sources, testing the strongest counterargument, and delivering the result. Do not pad time with idle waits, repetitive searches, unnecessary pages, or unrelated scope.

Do not finish early merely because the minimum deliverable is complete. If a genuine environment, context, tool, or permission limit prevents further useful work, save the strongest supported result and state the specific limit and remaining investigation. Report elapsed work only when measured; do not imply that this instruction guarantees a runtime or that work continues after your response.
...
DEPTH AND AMBITION
Focused pass. Plan for about 10 minutes of useful work in this turn where the environment permits. Complete the highest-value bounded task and its necessary verification. Preserve larger unresolved work as a checkpoint rather than pretending the whole project is finished. Keep the same quality and permission boundaries; do not pad time or prose. This is an effort preference, not a guaranteed runtime or model setting.
...
DEPTH AND AMBITION
Aim to spend a full 60 minutes of active, substantive work in this turn. Assume there is more than an hour of valuable revision available. The first fix is a checkpoint, not the finish line. Use the remaining effort on the most consequential unresolved findings, deeper connected behavior, craft, and verification. Save checkpoints and reserve the final part of the hour for verifying and delivering the actual artifact. Do not stop merely because the minimum request is satisfied; do not pad time with idle waits, repetitive checks, unnecessary pages, or unrelated scope. If a genuine environment, context, tool, or permission limit prevents further useful work, deliver the strongest usable result and state the specific limit and remaining work. Report elapsed time only when measured; this instruction does not guarantee runtime or work after the response.
...
AIM HIGH AND FINISH
Treat the first improved version as a checkpoint. Repeat inspect, improve, and verify passes, prioritizing the weakest consequential part of the result. Spend the available effort on meaningful completeness, behavior, clarity, and craft. Save recoverable versions and reserve the final part of the hour for verification and delivery. Do not stop at a plan, a promising fragment, or the first adequate answer. Do not fill time with idle waits, repetitive checks, unnecessary pages, or unrelated scope. If a genuine environment, context, tool, or permission limit blocks progress, deliver the strongest usable version and identify the specific limit. Report elapsed work only when measured; this request does not guarantee runtime or continued work after the response.
